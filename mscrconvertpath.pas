...
type
  TscrConvertPath = class(TForm)
    Label1: TLabel;
    Variable: TComboBox;
    Label2: TLabel;
    ShortPath: TRadioButton;
    LongPath: TRadioButton;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
...
var
  scrConvertPath: TscrConvertPath;
...
procedure TscrConvertPath.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
