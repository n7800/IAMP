...
type
  TscrReplaceString = class(TForm)
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    Label1: TLabel;
    Variable: TComboBox;
    IgnoreCase: TCheckBox;
    ReplaceAll: TCheckBox;
    Label2: TLabel;
    OldPattern: TEdit;
    Label3: TLabel;
    NewPattern: TEdit;
...
var
  scrReplaceString: TscrReplaceString;
...
procedure TscrReplaceString.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
