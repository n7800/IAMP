...
type
  TscrCheckDiskSpace = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    Variable: TComboBox;
    BitBtn1: TBitBtn;
...
var
  scrCheckDiskSpace: TscrCheckDiskSpace;
...
procedure TscrCheckDiskSpace.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
