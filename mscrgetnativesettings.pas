...
type
  TscrGetNativeSettings = class(TForm)
    Label1: TLabel;
    Variable: TComboBox;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    Label2: TLabel;
    Capability: TComboBox;
...
var
  scrGetNativeSettings: TscrGetNativeSettings;
...
procedure TscrGetNativeSettings.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
