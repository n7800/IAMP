...
/Applications/Lazarus/lazbuild --build-mode=Guiless miaxstub.lpr -B
strip ./miaxstub
cp ./miaxstub ./miacstub
chmod 777 ./miacstub
/Applications/Lazarus/lazbuild --build-mode=LicensedGuiless miaxstub.lpr --build-all
strip ./miaxstub
cp ./miaxstub ./miacstubl
chmod 777 ./miacstubl
/Applications/Lazarus/lazbuild --build-mode=Licensed miaxstub.lpr --build-all
strip ./miaxstub
cp ./miaxstub ./miaxstubl
chmod 777 ./miaxstubl
/Applications/Lazarus/lazbuild miamp.lpr --build-mode=Licensed --build-all
strip ./miamp
cp ./miamp ./miampl
chmod 777 ./miampl
/Applications/Lazarus/lazbuild miaxstub.lpr -B
strip ./miaxstub
/Applications/Lazarus/lazbuild miauix.lpr -B
strip ./miauix
/Applications/Lazarus/lazbuild miaxbuild.lpr -B
strip ./miaxbuild
/Applications/Lazarus/lazbuild miamp.lpr -B
strip ./miamp
/Applications/Lazarus/lazbuild mpax.lpr -B
strip ./mpax
/Applications/Lazarus/lazbuild trans/mTranslator.lpr -B
strip trans/mTranslator
cp 7zipbin/7za ./macos/miax.lib
chmod 777 ./miaxstub
chmod u-s ./miaxstub
chmod 777 ./miacstub
chmod u-s ./miacstub
