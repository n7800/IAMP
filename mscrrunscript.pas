...
uses
  ...
  Controls, Forms, Dialogs, ExtCtrls, StdCtrls, Buttons, Spin;

type
  TscrRunScript = class(TForm)
    Label1: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    Label2: TLabel;
...
procedure TscrRunScript.Button1Click(Sender: TObject);
var
  s: string;
  t: TStringList;
begin
  ...
  begin
    ...
    t.LoadFromFile(OpenDialog.FileName, TEncoding.UTF8);
    s := t.Text;
    Script.Lines.Text := s;
    t.Free;
  end;
...
procedure TscrRunScript.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
