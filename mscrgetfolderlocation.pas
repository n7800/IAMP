...
type
  TscrGetFolderLocation = class(TForm)
    Label1: TLabel;
    Variable: TComboBox;
    Label2: TLabel;
    Folder: TComboBox;
...
var
  ScrGetFolderLocation: TscrGetFolderLocation;
...
procedure TscrGetFolderLocation.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
