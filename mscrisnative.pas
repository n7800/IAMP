...
type
  TscrIsNativeSetupInstalled = class(TForm)
    Label1: TLabel;
    Guid: TEdit;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
...
var
  scrIsNativeSetupInstalled: TscrIsNativeSetupInstalled;
...
procedure TscrIsNativeSetupInstalled.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
