...
var
  scrExtract7Zip: TscrExtract7Zip;
...
procedure TscrExtract7Zip.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
...
procedure TscrExtract7Zip.BitBtn3Click(Sender: TObject);
begin
