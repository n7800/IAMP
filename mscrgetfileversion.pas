...
type
  TscrGetFileVersion = class(TForm)
    Label1: TLabel;
    FilePath: TEdit;
    Label2: TLabel;
    Variable: TComboBox;
...
var
  scrGetFileVersion: TscrGetFileVersion;
...
procedure TscrGetFileVersion.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
...
procedure TscrGetFileVersion.BitBtn3Click(Sender: TObject);
begin
  VirtualBrowse.BrowseWithTextControl(FilePath);
end;
