...
procedure TscrGetINI.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
...
procedure TscrGetINI.BitBtn3Click(Sender: TObject);
begin
  VirtualBrowse.BrowseWithTextControl(FileName);
end;
