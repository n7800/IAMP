...
uses
  ...
  OIDsgn,
  {$ENDIF NOTOOLSAPI}
  {$IFNDEF NODBCOMPONENTS}
  DBInspct,
  {$ENDIF}
  Classes, PropIntf, InspCtrl, CompInsp, AppInsp, IniInsp,
  SColInsp;
...
procedure Register;
begin
  RegisterComponents('Inspectors',[TPropertyInterface,TCommonInspector,TComponentInspector,TComponentTree,TComponentComboBox,TIniInspector,{$IFNDEF NODBCOMPONENTS}TDBInspector,{$ENDIF}TApplicationInspector,TSystemColorsInspector]);
  {$IFNDEF NOTOOLSAPI}
