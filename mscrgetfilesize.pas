...
var
  scrGetFileSize: TscrGetFileSize;
...
procedure TscrGetFileSize.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
...
procedure TscrGetFileSize.BitBtn3Click(Sender: TObject);
begin
