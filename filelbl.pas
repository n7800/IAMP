...
uses
  LCLIntf, LCLType, LMessages, Messages, SysUtils, {FastStrings,} Classes, Graphics, Controls, Forms, Dialogs,
  StdCtrls;
...
begin
  repeat
    EndOfCurrentString := AnsiPos(BreakString, BaseString);
