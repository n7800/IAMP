...
initialization
  ...
  DataDir := AssertDir(ExtractFilePath(MyParamStr(0)));
  {$IFDEF DARWIN}
  DataDir := ExtractFilePath(DeAssertDir(ExtractFilePath(DeAssertDir(ExtractFilePath(DeAssertDir(DataDir))))));
  {$ENDIF}
  DataDir := DataDir + 'benchdata' + PathDelim;
