...
procedure TscrRunProgram.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
...
procedure TscrRunProgram.BitBtn3Click(Sender: TObject);
begin
