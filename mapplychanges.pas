...
type
  TscrApplyChanges = class(TForm)
    ...
    Label5: TLabel;
    Variable: TComboBox;
    Install: TRadioButton;
    Action: TLabel;
    Uninstall: TRadioButton;
    Advertise: TRadioButton;
...
var
  scrApplyChanges: TscrApplyChanges;
...
procedure TscrApplyChanges.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
