...
procedure TscrReadBinary.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
...
procedure TscrReadBinary.BitBtn3Click(Sender: TObject);
begin
