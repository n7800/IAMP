...
procedure TscrFileBag.Button1Click(Sender: TObject);
begin
  if OpenDialog.Execute then
    Bag.Text := OpenDialog.FileName;
end;

procedure TscrFileBag.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
