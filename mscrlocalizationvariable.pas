...
type
  TscrLocalizationVariable = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    Variable: TComboBox;
    Value: TEdit;
...
var
  scrLocalizationVariable: TscrLocalizationVariable;
...
procedure TscrLocalizationVariable.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
