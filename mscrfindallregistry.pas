...
type
  TscrFindAllRegistry = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    Label4: TLabel;
    Variable: TComboBox;
...
var
  scrFindAllRegistry: TscrFindAllRegistry;
...
procedure TscrFindAllRegistry.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
...
procedure TscrFindAllRegistry.RootChange(Sender: TObject);
begin
