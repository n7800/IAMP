...
type
  TscrGetSystemSettings = class(TForm)
    Label1: TLabel;
    Variable: TComboBox;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
...
var
  scrGetSystemSettings: TscrGetSystemSettings;
...
procedure TscrGetSystemSettings.FormShow(Sender: TObject);
var
  i: Integer;
  s: String;
  sl: TStringList;
